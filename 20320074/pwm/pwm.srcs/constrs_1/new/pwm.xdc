...
set_property PACKAGE_PIN J16 [get_ports {pwm[3]}]
set_property PACKAGE_PIN K16 [get_ports {pwm[2]}]
set_property PACKAGE_PIN M15 [get_ports {pwm[1]}]
set_property PACKAGE_PIN M14 [get_ports {pwm[0]}]
